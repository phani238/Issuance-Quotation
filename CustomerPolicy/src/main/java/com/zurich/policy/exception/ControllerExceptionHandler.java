...
public class ControllerExceptionHandler {
	...
	public ResponseEntity<ErrorMessage> remoteServiceNotFoundException(RemoteServiceNotAvailableException ex,
			WebRequest request) {
		ErrorMessage message = new ErrorMessage(HttpStatus.REQUEST_TIMEOUT.value(), new Date(), ex.getMessage(),
				request.getDescription(false));
